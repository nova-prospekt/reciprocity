...
function getcategory(sel,budget_desc)


{
	var budgetCode = sel.options[sel.selectedIndex].value;
	document.getElementById('item'+budget_desc).options.length = 0;	// Empty city select box
...
{
	var obj = document.getElementById('item'+budget_desc);
