...
`claimed_by` ,`claim_status` ,`donated_date` ,`donated_time` ,`donate_type`)

VALUES ( '', '$cat_id', '$sub_category', '$item', '$descp', '$condition', '$userid', '', '0', '$curdate', '$curtime', 'generic')";
...
<form method="POST" action="donate.php" name="donatefrm" id="donates" enctype="multipart/form-data">
