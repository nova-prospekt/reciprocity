...
require_once '../library/config.php';
	...
	$getletter1 = "select * from letters where lettername = 'debtor'";
	...
	$sql = "update letters set
		lettername = '".$_REQUEST['debtor']."',
		cnd = '".$_REQUEST['debtor']."',
		reply = '".$_REQUEST['reply']."',
		subject = '".$_REQUEST['subject']."',
		bodytext = '".$_REQUEST['bodytext']."',
		letterdate = '".$_REQUEST['datetype']."' where  lettername = 'debtor'";
	...
	$getletter = "select * from letters where lettername = 'debtor'";
...
<div class="page">
  ...
  <div class="box1">
    	<h1> To Debtor </h1>
        <form action="" name="debtor" method="post">
  ...
  <tr>
    <td><textarea rows="4" cols="40" name="debtor"  style="text-align:center; padding-top:15px; font-size:15px;"> <?php echo $rsletter['cnd'];?></textarea></td>
    </tr>
  <tr>
    <td>Body Message </td>
    <td>&nbsp;</td>
  ...
  <tr>
	...
	<input type="hidden" name="debtor" value="debtor" />
