...
<div class="photo">	
    ...
    width: 110px;" alt="" /></div>
						                                                ...
						                                                <p style="float:left; margin-top:95px; margin-left:13px;">

                                               

                                          

                                          <a  href="#<?php echo $fetch_donate1['id'];?>"> Click for more </a></p>
    ...
    <?php } ?>      
      ...
      <div id="<?php echo $fetch['id'];?>">
          ...
          <img src="images/<?php echo $fetch['image'];?>" style="width:50px; height:50px;" />
          

         <div style="height:100px; width:200px; margin-top:10px;">
       <?php echo $item_name2;
	   
	   ?>
          <?php echo '<br>'. $username;?>
          <?php echo 'Claimed By: '.$claimedby;
...
<div class="ca-item ca-item-1" id="counter_<?php echo $claim_id;?>" style="display:none; height:168px; ">
  ...
  <p style="float:left;">  <?php echo $item_name;?></p>
    ...
    <p style="float:left;">Donated By: <?php echo $donated_username;?></p>
      ...
      <p> <input type="radio" class="validate[required]" name="condition" value="Great">&nbsp;Great &nbsp;&nbsp;

              <input type="radio" name="condition" value="Ok">&nbsp;Good &nbsp;&nbsp;

              <input type="radio" name="condition" value="Good">&nbsp;Ok &nbsp;&nbsp;</p>

               <input type="hidden" name="claim_idssss" id="claim_id" value="<?php echo $claim_id?>">

              <p><input type="submit" name="confirm" value="Confirm Received" ><input type="submit" name="cancel" value="Cancel" >
 </p>
  ...
  <p style="float:left;">  <?php echo $item_name;?></p>
    ...
    <p style="float:left;">Donated By: <?php echo $donated_username;?></p>
      ...
      <p> <input type="radio" class="validate[required]" name="condition" value="Great">&nbsp;Great &nbsp;&nbsp;
              ...
              <p><input type="submit" name="confirm" value="Confirm Received" ><input type="submit" name="cancel" value="Cancel Claim"></p>

        <p><a href="processclaim.php?donate_id=<?php echo $claim_id;?>" onClick = "javascript: return confirm('Do you want to Confirm this?');"> Confirm</a>
