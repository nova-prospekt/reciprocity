...
require_once 'library/config.php';
	...
	$sql=mysql_query("select * from item where item_id='$prod_id'") or die(mysql_error());
 ...
 <table  width="100%" border="0" cellspacing="5" cellpadding="0" style="border-top:solid 3px #CCCCCC;" align="center">
  <tr>
    ...
    <td width="83%"><select name="cat_name" id="cat_name" class="validate[required] txt-feild-small" onchange="getbudget(this,'')">
		...
		?>
        <option <?php if($cat_id==$fetch_cat['cat_id']){ echo 'selected="selected"';}?>   value="<?php echo $fetch_cat['cat_id'];?>"><?php echo $fetch_cat['cat_name'];?></option>
        <?php } ?>
    </select></td>
  </tr>
   <tr>
    <td valign="top"><strong>Item Name</strong></td>
    <td><input type="text" class="validate[required] txt-feild-small" name="item_name" id="item_name" value="<?php echo $fetch['item_name'];?>" /></td>
  </tr>
  <tr>
    <td valign="top"><strong>Item Sub Category</strong></td>
    <td><input type="text" name="sub_cat" id="sub_cat" value="<?php echo $fetch['sub_category'];?>" class="validate[required] txt-feild-small"  /></td>
  </tr>
  <tr>
    <td valign="top"><strong>E Base</strong></td>
    <td><input type="text" name="base" id="base" class="validate[required] txt-feild-small" value="<?php echo $fetch['ebase'];?>" /></td>
  </tr>
  <tr>
    <td valign="top"><strong>E Max</strong></td>
    <td><input type="text" name="max" id="max" class="validate[required] txt-feild-small" value="<?php echo $fetch['emax'];?>" /></td>
  </tr>
  <tr>
    <td valign="top"><strong>E Med</strong></td>
    <td><input type="text" name="med" id="med" class="validate[required] txt-feild-small" value="<?php echo $fetch['emed'];?>" /></td>
  </tr>
  <tr>
    <td valign="top"><strong>E Min</strong></td>
    <td><input type="text" name="min" id="min" class="validate[required] txt-feild-small"  value="<?php echo $fetch['emin'];?>"/></td>
  </tr>
  
  
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" name="edit_prod" value="Save" class="btn1" /></td>
  </tr>
</table>
