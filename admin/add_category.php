...
require_once 'library/config.php';
	...
	if(isset($_POST['add_cat']))
	{
		...
		$cat_worth=$_POST['cat_worth'];
		$insert="insert into category set cat_id='$cat_id',cat_name='$cat_name'";
...
<td colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td width="83%"><input type="text" class="validate[required] txt-feild-small" name="cat_id" id="cat_id" /></td>
  </tr>
