...
require_once 'library/config.php';
	...
	$select=mysql_query("select * from sub_category where id='$cat_id'") or die(mysql_error());
	$fetch=mysql_fetch_array($select);
	$cat_name=$fetch['sub_catname'];
	...
	if(isset($_POST['edit_cat']))
	{
		...
		$update="update sub_category set sub_catname='$cat_name' where id='$cat_id'";
