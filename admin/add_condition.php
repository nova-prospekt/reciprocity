...
require_once 'library/config.php';
	...
	if(isset($_POST['add_cat']))
	{
		...
		$insert="INSERT INTO `conditions` set `condition`='$cond' ,`condition_pts`='$cond_pts'  ";
...
<td colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td width="83%"><input type="text" class="validate[required] txt-feild-small" name="cond" id="cond" /></td>
  </tr>
  <tr>
    <td width="17%" valign="top"><strong>Condition Points</strong></td>
    <td width="83%"><input type="text" class="validate[required] txt-feild-small" name="cond_pts" id="cond_pts" /></td>
  </tr>
  <tr>
<td colspan="2">&nbsp;</td>
</tr>
