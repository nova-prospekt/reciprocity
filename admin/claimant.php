...
require_once '../library/config.php';
	...
	$getletter1 = "select * from letters where lettername = 'claimant'";
	...
	$sql = "update letters set
		lettername = '".$_REQUEST['claim']."',
		cnd = '".$_REQUEST['claimant']."',
		reply = '".$_REQUEST['reply']."',
		subject = '".$_REQUEST['subject']."',
		bodytext = '".$_REQUEST['bodytext']."',
		letterdate = '".$_REQUEST['datetype']."' where  lettername = 'claimant'";
	...
	$getletter = "select * from letters where lettername = 'claimant'";
...
<div class="page">
  ...
  <div class="box1">
    	<h1> To Claimant</h1>
        <form action="" method="post" name="cliament">
  ...
  <tr>
    <td><textarea rows="4" cols="40" name="claimant"  style="text-align:center; padding-top:15px; font-size:15px;">
	<?php echo $rsletter['cnd'];?></textarea></td>
    </tr>
  <tr>
    <td>Body Message </td>
    <td>&nbsp;</td>
  ...
  <tr>
	...
	<input type="hidden" name="claim" value="claimant" />
